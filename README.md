...
- **Página de Pagar Productos :** En este template se ve el detalle de la orden realizada y el botón "Pagar" ,que redirije a la aplicación de la billetera. :shopping: <br>
